...
interface TaskyApi {
    ...
    @POST("/syncAgenda")
    suspend fun syncAgenda(@Body syncAgendaBody: SyncAgendaRequest): Response<Unit>
    ...
    @DELETE("/event")
    suspend fun deleteEventById(@Query("eventId") eventId: String): Response<Unit>
    ...
    @DELETE("/task")
    suspend fun deleteTaskById(@Query("taskId") taskId: String): Response<Unit>
    ...
    @DELETE("/reminder")
    suspend fun deleteReminderById(@Query("reminderId") reminderId: String): Response<Unit>
